...
const LetterGlitch = ({
  ...
  // Debug: Log current props
  console.log('LetterGlitch props:', { centerVignette, outerVignette, glitchSpeed, smooth });
  
  // Effect to handle prop changes
  useEffect(() => {
    console.log('Props changed:', { centerVignette, outerVignette, glitchSpeed, smooth });
  }, [centerVignette, outerVignette, glitchSpeed, smooth]);
